            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form role="form" class="form form-horizontal" method="post" action="{{ route('service.store') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 input-element {{ $errors->has('description') ? 'has-error' : '' }}">
                                            <textarea name="description" id="service_ckeditor"></textarea>
                                        ...
                                        <div class="col-md-10 pr-3 input-element {{ $errors->has('image') ? 'has-error' : '' }}">
                                            <span class="col-12 pl-0">
                                                <span class="btn btn-success fileinput-button">
                                                    ...
                                                    <input type="file" name="image" id="files" accept="image/jpeg, image/png, image/gif,"><br/>
                                                </span>
                                            </span>
                                            <br><br>
