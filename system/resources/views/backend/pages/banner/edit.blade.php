            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('banner.edit', $banner->id) }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 input-element {{ $errors->has('description') ? 'has-error' : '' }}">
                                            <textarea name="description" id="banner_ckeditor">{{ $banner->description }}</textarea>
                                        ...
                                        <div class="col-md-10 pr-3 input-element {{ $errors->has('photo') ? 'has-error' : '' }}">
                                            <div class="col-12 pl-1 row">
                                                ...
                                                <ul class="thumb-Images">
                                                    <li>
                                                        <img class="thumb" src="{{ asset('assets/images/banners/'.$banner->photo) }}" height="70" width="70">
                                                        <div>Old Image</div>
                                                    </li>
                                                </ul>
