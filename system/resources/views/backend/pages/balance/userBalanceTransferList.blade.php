            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button link="{{route('balance.add.user')}}" class="btn btn-primary btn-md submit"><i class="d-md-none d-block feather icon-plus"></i>
    ...
    <script>
        ...
        $(document).on("click", "#change_status_menu", function (event) {
            if(confirm("Are you sure to approved?")) {
                ...
                var route = '{{ route('balance.status.user', ':id') }}';
        ...
        {{--    var url = '{{ route('balance.add.user') }}';--}}
