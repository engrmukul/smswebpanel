            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('country.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <h4 class="form-section">Add New Country</h4>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="Country Name" name="name" value="{{ old('name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('nickname') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="Nick Name" name="nickname" value="{{ old('nickname') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('phonecode') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="Phone Code" name="phonecode" value="{{ old('phonecode') }}">
