        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a class="ajax-form" href="{{ route('emailconfig.serviceprovider.list') }}">Service Provider List</a>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('emailconfig.serviceprovider.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="Service Provider Name" name="name" value="{{ old('name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="API Provider Name" name="api_provider" value="{{ old('api_provider') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('provider_type') ? 'has-error' : '' }}">
                                            <select id="provider_type" class="form-control custom-select block border-primary" name="provider_type">
                                                ...
                                                <option value="HTTP" {{ (old('provider_type') == 'HTTP')? 'selected': '' }}>HTTP</option>
                                                <option value="SMTP" {{ (old('provider_type') == 'SMTP')? 'selected': '' }}>SMTP</option>
                                                <option value="SDK" {{ (old('provider_type') == 'SDK')? 'selected': '' }}>SDK</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('url') ? 'has-error' : '' }}">
                                            <input type="text" id="url" class="form-control border-primary" placeholder="Email Provider URL" name="url" value="{{ old('url') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('tls') ? 'has-error' : '' }}">
                                            <select id="tls" class="form-control custom-select block border-primary" name="tls">
                                                ...
                                                <option value="Yes" {{ (old('tls') == 'Yes')? 'selected': '' }}>Yes</option>
                                                <option value="No" {{ (old('tls') == 'No')? 'selected': '' }}>No</option>
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('api_key') ? 'has-error' : '' }}">
                                            <input type="text" id="api_key" class="form-control border-primary" name="api_key" value="{{ old('api_key') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('secret_key') ? 'has-error' : '' }}">
                                            <input type="text" id="secret_key" class="form-control border-primary" name="secret_key" value="{{ old('secret_key') }}">
