            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('emailconfig.route.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('user') ? 'has-error' : '' }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('source_domain') ? 'has-error' : '' }}">
                                            <input type="text" id="source_domain" class="form-control border-primary" name="source_domain" value="{{ old('source_domain') }}">
