            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button link="{{ route('reseller.add') }}" class="btn btn-primary btn-md submit"><i class="d-md-none d-block feather icon-plus"></i>
                            <span class="d-md-block d-none">Add Reseller</span>
                        </button>
...
@section('pageJS')
    ...
    <script>
        ...
        $(document).on("click", "#change_status_menu", function () {
            var route = '{{ route('reseller.status', ':id') }}';
