            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('reseller.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('reseller_name') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" placeholder="Reseller Name" name="reseller_name" value="{{ old('reseller_name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('thana') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" placeholder="Thana/Upzilla" name="thana" value="{{ old('thana') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('email_rate') ? 'has-error' : '' }}">
                                            <select class="form-control block" name="email_rate" required>
                                                ...
                                                @foreach($smsRates as $smsRate)
                                                    <option value="{{ $smsRate->id }}" {{ (old('email_rate') == $smsRate->id)? 'selected': '' }}>{{ $smsRate->rate_name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('site_url') ? 'has-error' : '' }}">
                                            <input type="text" class="form-control" placeholder="Site Url" name="site_url" value="{{ old('site_url') }}">
