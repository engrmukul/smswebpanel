                                ...
                                <div class="form-actions">
                                    <div class="form-group mb-0 justify-content-end row">
                                        <div class="col-md-12 pl-2">
                                            <button type="submit" id="saveAsDraft" value="Draft" name="submit" class="btn btn-primary generalFormSubmit">
                                                ...
                                                <i class="fa fa-first-order generalFormSubmitButtonText"></i> Save As Draft
                                            </button>

                                            <button type="submit" class="btn btn-primary generalFormSubmit" id="SendSMSNow">
                                                <code class="btn btn-sm d-none generalFormSubmitSpinner"><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...</code>
                                                <i class="fa fa-check-square-o generalFormSubmitButtonText"></i> Send
                                            </button>
