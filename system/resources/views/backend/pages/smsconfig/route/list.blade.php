            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <button link="{{ route('smsconfig.route.add') }}" class="btn btn-primary btn-md submit"><i class="d-md-none d-block feather icon-plus"></i>
...
@section('pageJS')
    ...
    <script>
        ...
        $(document).on("click", "#change_status_menu", function () {
            var route = '{{ route('smsconfig.route.status', ':id') }}';
