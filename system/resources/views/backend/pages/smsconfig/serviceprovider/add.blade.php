            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('smsconfig.serviceprovider.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <h4 class="form-section">Add New SMS Provider</h4>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="SMS Provider Name" name="name" value="{{ old('name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('name') ? 'has-error' : '' }}">
                                            <input type="text" id="name" class="form-control border-primary" placeholder="SMS Provider Name" name="api_provider" value="{{ old('api_provider') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('channel_type') ? 'has-error' : '' }}">
                                            <select id="channel_type" class="form-control custom-select block border-primary" name="channel_type">
                                                ...
                                                <option value="HTTP" {{ (old('channel_type') == 'HTTP')? 'selected': '' }}>HTTP</option>
                                                <option value="SMPP" {{ (old('channel_type') == 'SMPP')? 'selected': '' }}>SMPP</option>
                                            </select>
                                            <span class="text-danger">{{ $errors->first('channel_type') }}</span>
                                        </div>
                                    </div>

                                    <div class="form-group row" id="methodHide" style="display: {{ ($errors->has('method') or old('method') != '') ? '' : 'none' }}">
                                    ...
                                    <div class="form-group row" id="contentHide" style="display: {{ ($errors->has('content_type') or old('content_type') != '')  ? '' : 'none' }}">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('url') ? 'has-error' : '' }}">
                                            <select id="content_type" class="form-control custom-select block border-primary" name="content_type">
                                                ...
                                                <option value="ARRAY" {{ (old('content_type') == 'ARRAY')? 'selected': '' }}>ARRAY</option>
                                                <option value="JSON" {{ (old('content_type') == 'JSON')? 'selected': '' }}>JSON</option>
                                            </select>
                                            <span class="text-danger">{{ $errors->first('content_type') }}</span>
                                        </div>
                                    </div>

                                    <div class="form-group row" id="urlHide" style="display: {{ ($errors->has('url') or old('url') != '')  ? '' : 'none' }}">
                                        <label class="col-md-2 col-form-label label-control" for="url">Send SMS Base URL <i class="fa fa-star danger"></i></label>
                                        <div class="col-md-10 input-element {{ $errors->has('url') ? 'has-error' : '' }}">
                                            <input type="text" id="url" class="form-control border-primary" placeholder="Send SMS Base URL" name="url" value="{{ old('url') }}">
                                            <span class="text-danger">{{ $errors->first('url') }}</span>
                                        </div>
                                    </div>

                                    <div class="form-group row" id="ipHide" style="display: {{ ($errors->has('ip') or old('ip') != '') ? '' : 'none' }}">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('ip') ? 'has-error' : '' }}">
                                            <input type="text" id="ip" class="form-control border-primary" name="ip" value="{{ old('ip') }}">
                                            <span class="text-danger">{{ $errors->first('ip') }}</span>
                                        </div>
                                    </div>

                                    <div class="form-group row" id="portHide" style="display: {{ ($errors->has('port') or old('port') != '') ? '' : 'none' }}">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('port') ? 'has-error' : '' }}">
                                            <input type="text" id="port" class="form-control border-primary" name="port" value="{{ old('port') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('account_code') ? 'has-error' : '' }}">
                                            <input type="text" id="account-code" class="form-control border-primary" name="account_code" value="{{ old('account_code') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('username') ? 'has-error' : '' }}">
                                            <input type="text" id="username" class="form-control border-primary" name="username" value="{{ old('username') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('password') ? 'has-error' : '' }}">
                                            <input type="text" id="password" class="form-control border-primary" name="password" value="{{ old('password') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('tps') ? 'has-error' : '' }}">
                                            <input type="text" id="tps" class="form-control border-primary" name="tps" value="{{ old('tps') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('mode') ? 'has-error' : '' }}">
                                            <input type="text" id="mode" class="form-control border-primary" name="mode" value="{{ old('mode') }}">
