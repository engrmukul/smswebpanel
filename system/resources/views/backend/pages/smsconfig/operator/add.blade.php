            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('smsconfig.operator.add.post') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <h4 class="form-section">Add New Operator</h4>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('full_name') ? 'has-error' : '' }}">
                                            <input type="text" id="full_name" class="form-control border-primary" placeholder="Operator Name" name="full_name" value="{{ old('full_name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('short_name') ? 'has-error' : '' }}">
                                            <input type="text" id="short_name" class="form-control border-primary" placeholder="Short Name" name="short_name" value="{{ old('short_name') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('prefix') ? 'has-error' : '' }}">
                                            <input type="text" id="prefix" class="form-control border-primary" placeholder="Prefix" name="prefix" value="{{ old('prefix') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('ton') ? 'has-error' : '' }}">
                                            <input type="text" id="ton" class="form-control border-primary" placeholder="TON" name="ton" value="{{ old('ton') }}">
                                            <span class="text-danger">{{ $errors->first('prefix') }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 input-element {{ $errors->has('npi') ? 'has-error' : '' }}">
                                            <input type="text" id="npi" class="form-control border-primary" placeholder="NPI" name="npi" value="{{ old('npi') }}">
