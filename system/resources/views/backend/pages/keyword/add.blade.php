            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form class="form form-horizontal" method="post" action="{{ route('keywords.store') }}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('title') ? 'has-error' : '' }}">
                                            <input type="text" id="title" class="form-control" placeholder="Gov blacklisted word" name="title" value="{{ old('title')}}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 pr-3 pl-3 input-element {{ $errors->has('keywords') ? 'has-error' : '' }}">
                                            <input data-role="tagsinput" type="text" id="keywords" class="form-control bootstrap-tagsinput" placeholder="Delete" name="keywords" value="{{ old('keywords')}}">
